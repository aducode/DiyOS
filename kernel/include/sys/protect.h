...
//存储段描述符类型
/*
#define DA_DR		0x00//0x90    //存在的只读数据段类型值
#define DA_DRW		0x02//0x92	//存在的可读写数据段属性值
#define DA_DRWA		0x03//0x93	//存在的已访问可读写数据段类型值
#define DA_C		0x08//0x98	//存在的只执行代码段属性值
#define DA_CR		0x0A//0x9A	//存在的可执行可读代码段属性值
#define DA_CCO		0x0C//0x9C	//存在的只执行一致代码段属性值
#define DA_CCOR		0x0E//0x9E	//存在的可执行可读一致代码段属性值
*/
//系统段描述符类型
/*
